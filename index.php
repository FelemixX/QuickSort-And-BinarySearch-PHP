...
<head>
    ...
    <!--
        Подключение bootstrap для вывода на страничку
    -->
...
function binarySearch(array $array, $searchFor)
{
    ...
    $low = 0;
    $high = count($array) - 1; //count - возвращает количество элементов в массиве
